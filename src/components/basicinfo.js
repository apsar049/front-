                ...
                <div className="bottom-section">
                    ...
                    <div className="button-section">
                        ...
                        <div className="similar-button">
                            <button className="btn1"><span><i className="fa-regular fa-circle-1"></i></span>
                            <span>Basic Info</span></button>
                        </div>
                        <div className="similar-button">
                    ...
                    <div className="details-section">
                        ...
                        <div className="down-buttons">
                            ...
                            <span><Link to="./propertydetails"><button className="save">save & continue</button></Link></span>
                        </div>
                    </div>
